...
class TrainingLog(UUIDPrimaryKeyMixin, TimestampMixin, Base):
    ...
    intensity: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    notes: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    logged_at: Mapped[datetime] = mapped_column(sa.TIMESTAMP(timezone=True), nullable=False, default=_now_utc)
...
class TrainingGoal(UUIDPrimaryKeyMixin, TimestampMixin, Base):
    ...
    target_date: Mapped[Optional[datetime]] = mapped_column(sa.TIMESTAMP(timezone=True), nullable=True)
